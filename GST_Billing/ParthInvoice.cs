...
{
    public partial class ParthInvoice : Form
    {
        ...
        public ParthInvoice(string invoiceNo, int invoiceType)
        {
            try
            {
                InitializeComponent();
                ...
                string sqlstr1 = @"SELECT invoiceDetails.invoiceNo as invoiceNo, invoiceDetails.invoiceDate as invoiceDate, invoiceDetails.shipName as shipName, userDetails.city as city,
                                ...
                                customerDetails.custname as custname, customerDetails.custPanno as custPanno, customerDetails.shipPanno as shipPanno, 
                                ...
                                (customerDetails.custaddress || "", "" || customerDetails.custlandmark || "", "" || customerDetails.custcity || ""-"" || customerDetails.custpincode || "", "" || customerDetails.custstate) AS custaddress,
                ...
                ReportDocument cryRpt = new ParthInvoicePrint();
